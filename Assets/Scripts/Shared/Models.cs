...
namespace AshRoad.Models
{
    ...
    [Serializable] public class StoryProgressData { public HashSet<string> clues = new(); public HashSet<string> clueGroups = new(); public HashSet<string> scenes = new(); public bool trueEndingEligible; }
}
